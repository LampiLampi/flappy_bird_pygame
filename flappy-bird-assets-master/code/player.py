...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image1 = pygame.image.load(r'../sprites/bluebird-downflap.png').convert_alpha()
        self.image1 = pygame.transform.scale(self.image1, (68, 48))
        self.image2 = pygame.image.load(r'../sprites/bluebird-midflap.png').convert_alpha()
        self.image2 = pygame.transform.scale(self.image2, (68, 48))
        self.image3 = pygame.image.load(r'../sprites/bluebird-upflap.png').convert_alpha()
        ...
        self.jump = pygame.mixer.Sound(r'../audio/wing.wav')
